...
export const SolicitudAmistadRecibida = () => {
    ...
    <>
      ...
      <main className='seccion container'>
        ...
        <section className='perfil container'>
            <h1>¿Desea aceptar la solicitud de amistad enviada por {usuarioCargado.username}?</h1>
...
export default SolicitudAmistadRecibida
